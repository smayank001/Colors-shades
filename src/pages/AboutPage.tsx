  ...
  return (
    <div className="bg-[#F9F7F5] min-h-screen">
      ...
      <section className="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32 bg-white">
        ...
        <div className="container relative mx-auto px-4 lg:px-8 text-center max-w-5xl">
          ...
          >
            ...
            <h1 className="text-6xl sm:text-7xl md:text-8xl font-black text-[#1E293B] leading-[1.1] mb-10 tracking-tight">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              className="relative"
            >
              <div className="relative rounded-[60px] overflow-hidden border-[16px] border-[#F9F7F5] shadow-2xl aspect-square">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-5xl font-black text-[#1E293B] mb-8 leading-tight">Our <span className="text-[#4D96FF]">Philosophy</span></h2>
      ...
      <section className="py-32 bg-[#F9F7F5]">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="bg-white rounded-[80px] p-12 md:p-24 shadow-soft border border-white relative overflow-hidden">
            {/* Background pattern */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center relative z-10">
              <div className="lg:col-span-7">
                ...
                <h2 className="text-5xl md:text-6xl font-black text-[#1E293B] mb-4">S S Swetha</h2>
